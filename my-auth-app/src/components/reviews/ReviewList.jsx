...
export default function ReviewList({ providerId }) {
  ...
  if (reviews.length === 0) {
    return (
      <div className="text-center py-8 bg-gray-50 rounded-lg border border-gray-200">
        ...
        <p className="mt-1 text-sm text-gray-500">Be the first to leave a review for this service provider.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        {reviews.map((review) => (
          <div key={review._id} className="bg-white rounded-lg border border-gray-200 shadow-sm p-4 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center">
                ...
                <div className="flex items-center text-yellow-400">
                  <span className="text-sm font-semibold mr-1">{review.rating}</span>
